 ...
 ****************************************************************************
 */
package com.sustech.ntagI2C.reader;
...
import com.sustech.ntagI2C.activities.MainActivity;
import com.sustech.ntagI2C.exceptions.CC_differException;
import com.sustech.ntagI2C.exceptions.CommandNotSupportedException;
import com.sustech.ntagI2C.exceptions.DynamicLockBitsException;
import com.sustech.ntagI2C.exceptions.NotPlusTagException;
import com.sustech.ntagI2C.exceptions.StaticLockBitsException;
import com.sustech.ntagI2C.listeners.WriteEEPROMListener;
import com.sustech.ntagI2C.listeners.WriteSRAMListener;
...
public class Ntag_I2C_Commands extends I2C_Enabled_Commands {
	...
	public byte[] getConfigRegisters() throws IOException, FormatException {
		...
		if (getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_1k || getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_1k_Plus  || getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus)
			reader.SectorSelect((byte) 0);
...
//		}
	...
	public void writeEEPROM(byte[] data, WriteEEPROMListener listener) throws IOException, FormatException {
		...
		for (index = 0; index < data.length && blockNr != 0; index += 4) {
			...
			if(getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus && blockNr == (byte) 0xE2) {
				break;
			}
	...
	public byte[] readEEPROM(int absStart, int absEnd) throws IOException,
		...
		while (fetchStart <= absEnd) {
			...
			if (getProduct() != Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus) {
	...
	public int writeDeliveryNdef() throws IOException, FormatException,
		...
		if (getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_1k || getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_1k_Plus) {
			// CC for NTAG 1k
		...
		} else if (getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_2k || getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus) {
			// CC for NTAG 2k
			data[index++] = (byte) 0xE1;
			data[index++] = (byte) 0x10;
		...
		} else if (getProduct() == Ntag_Get_Version.Prod.NTAG_I2C_2k_Plus) {
			eq = reader.read((byte) 0xE2);
		}
